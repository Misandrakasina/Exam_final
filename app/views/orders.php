...
<head>
    ...
    <script type="module" crossorigin src="/assets/orders-Cge2POod.js"></script>
    ...
    <style>
        ...
        /* Conteneur du formulaire avec overlay semi-transparent */
        .contact-card {
            background: rgba(0, 0, 0, 0.65);
            /* Noir semi-transparent (ajuste 0.65 pour plus/moins transparent) */
            backdrop-filter: blur(8px);
            /* Effet verre dépoli (optionnel, très joli) */
        ...
        .contact-card label {
            color: #e0f7fa;
            /* Bleu très clair pour le texte */
        }

        /* Champs de formulaire en mode sombre + transparent */
        .form-control {
        ...
        <div class="admin-wrapper" id="admin-wrapper">
            ...
            <main class="admin-main">
                <div class="container-fluid p-4 p-lg-5">
                    ...
                    <div class="contact-card text-center">
                        <!-- Icône enveloppe (tu peux la remplacer par Bootstrap Icons ou une image) -->
                        <div class="heart-icon"><i class="bi bi-heart ms-2"></i></div>
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                <label for="dons" class="form-label visually-hidden">Dons</label>
                                <input type="text" class="form-control" name="dons" id="dons" placeholder="Dons..." required>
                            </div>

                            <div class="mb-3">
                                <label for="quantite" class="form-label visually-hidden">Quantité</label>
                                <input type="text" class="form-control" name="quantite" id="quantite" placeholder="Quantité..." required>
                            </div>

                            <div class="mb-3">
                                <label for="prix_unitaire" class="form-label visually-hidden">Prix_Unitaire</label>
                                <input type="text" class="form-control" name="prix_unitaire" id="prix_unitaire" placeholder="Prix Unitaire..." required>
                            </div>
            ...
            <footer class="admin-footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-0 text-muted">© ETU004608 ETU003992 ETU004372</p>
                        </div>

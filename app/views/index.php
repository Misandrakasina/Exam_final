...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            background-color: #87CEEB !important; /* Bleu ciel plus foncé */
        ...
        /* Assurer que tous les éléments utilisent les nouvelles couleurs */
        * {
            color: inherit;
        }
    </style>
  ...
  <div class="container h-100">
    <div class="row align-items-stretch g-0">  <!-- Pas d'espace entre les colonnes -->
      ...
      <div class="col-lg-6 d-flex flex-column justify-content-center px-4 px-lg-5 py-5 py-lg-0">
        ...
        <h2 class="h2 fw-semibold text-dark mb-4" style="letter-spacing: 2px;">
          Offrez un don pour nos amis , famille
        </h2>
        <p class="lead text-dark mb-5" style="max-width: 480px; font-size: 1.3rem;">
        Offrons pour nos amis , famille , et les personnes dans le besoin , un don pour les aider à surmonter les difficultés et à construire un avenir meilleur ensemble . Votre générosité peut faire une différence significative dans la vie de ceux qui en ont besoin. Rejoignez-nous pour créer un impact positif et apporter de l'espoir à ceux qui en ont le plus besoin.
        </p>
